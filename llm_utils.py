...
def explain_lyrics(song_name, artist_name, language, docs):
    ...
    prompt = PromptTemplate(
        ...
        Provide insights into the artist's perspective, connecting the lyrics to their possible life experiences or themes in Punjabi music.
        Maintain a balance between detailed interpretation and simplicity, making the explanation easy to understand for everyone, regardless of their knowledge of Punjabi music.
